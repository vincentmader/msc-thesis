\section{Continuous Formulation}
    ...
    % \todo{As with the coagulation kernel, the fragmentation kernel will be separated into a 
    % positive and a negative ("gain" and "loss") term as well:}
    % \begin{align}
    ...
    \todo{Plugging this definition into [cite Smol. eq.]}, the
    ...
    \todo{We can reduce the 2D integral in the second term to a 1D integral.}
    \todo{For this, we make use of the relationship}
    \begin{equation}
