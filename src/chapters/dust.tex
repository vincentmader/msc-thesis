...
\section{Dust Particle Collisions}
    ...
    \subsection{Collision Cross Section}
        ...
        \todo{As already mentioned in (\todo{cite}), for the studies made in this thesis, 
              we assume a perfectly spherical dust particle shapes.} \\

        \todo{Therefore, the cross section $\sigma_{ij}$ for the collision of two dust particles 
              with radii $a_i$ and $a_j$ can be approximated by the area of a circle whose radius 
              equals the sum of the two particle radii.} \\

        \todo{As such, the collision cross section can be written as:}
        \begin{equation}
