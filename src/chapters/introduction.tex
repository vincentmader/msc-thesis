...
\section{Preliminary Notes on Axis Discretization}
    ...
    \label{subsec:axis_discretization_with_linear_scale}
        ...
        For a given bin, characterized by the index $i$, the mass value corresponding to the bin's
        lower boundary shall be labeled $m_i^\text{b}$. When using a linear scaling, it can be 
        expressed as
        \begin{align}
