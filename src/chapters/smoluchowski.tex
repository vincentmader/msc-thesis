...
\label{sec:fragmentation_kernel}
    ...
    \clearpage\subsection{Modeling the Resulting Mass Distribution}
...
\newpage\section{Numerical Integration}
    ...
    \clearpage\subsection{Implicit Radau Scheme}
        ...
        \begin{figure}[h!]
            ...
            \caption{\todo{only hit-and-stick coagulation}}
        \end{figure} 
        ...
        \begin{figure}[h!]
            ...
            \caption{\todo{only fragmentation, "big m0"}}
        \end{figure} 
        ...
        \begin{figure}[h!]
            ...
            \caption{\todo{"full model": coagulation + fragmentation}}
        \end{figure} 
